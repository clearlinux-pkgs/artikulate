...
Source0  : https://download.kde.org/stable/release-service/21.04.2/src/artikulate-21.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/21.04.2/src/artikulate-21.04.2.tar.xz.sig
...
%prep
%setup -q -n artikulate-21.04.2
cd %{_builddir}/artikulate-21.04.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1623359732
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/artikulate-21.04.2/COPYING %{buildroot}/usr/share/package-licenses/artikulate/2a638514c87c4923c0570c55822620fad56f2a33
cp %{_builddir}/artikulate-21.04.2/COPYING.DOC %{buildroot}/usr/share/package-licenses/artikulate/7b3e5f0e946c0b599b04a45deebb1aaed782070d
cp %{_builddir}/artikulate-21.04.2/LICENSES/BSD-2-Clause.txt %{buildroot}/usr/share/package-licenses/artikulate/680ed9349d3d12bd39ddd36e8c4bc6b1b0cb1c0e
cp %{_builddir}/artikulate-21.04.2/LICENSES/CC-BY-SA-4.0.txt %{buildroot}/usr/share/package-licenses/artikulate/7b3e5f0e946c0b599b04a45deebb1aaed782070d
cp %{_builddir}/artikulate-21.04.2/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/artikulate/8287b608d3fa40ef401339fd907ca1260c964123
cp %{_builddir}/artikulate-21.04.2/LICENSES/GPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/artikulate/2a638514c87c4923c0570c55822620fad56f2a33
cp %{_builddir}/artikulate-21.04.2/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/artikulate/e712eadfab0d2357c0f50f599ef35ee0d87534cb
cp %{_builddir}/artikulate-21.04.2/LICENSES/GPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/artikulate/6091db0aead0d90182b93d3c0d09ba93d188f907
cp %{_builddir}/artikulate-21.04.2/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/artikulate/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/artikulate-21.04.2/LICENSES/LGPL-2.1-only.txt %{buildroot}/usr/share/package-licenses/artikulate/3c3d7573e137d48253731c975ecf90d74cfa9efe
cp %{_builddir}/artikulate-21.04.2/LICENSES/LGPL-2.1-or-later.txt %{buildroot}/usr/share/package-licenses/artikulate/6f1f675aa5f6a2bbaa573b8343044b166be28399
cp %{_builddir}/artikulate-21.04.2/LICENSES/LGPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/artikulate/757b86330df80f81143d5916b3e92b4bcb1b1890
cp %{_builddir}/artikulate-21.04.2/LICENSES/LGPL-3.0-or-later.txt %{buildroot}/usr/share/package-licenses/artikulate/757b86330df80f81143d5916b3e92b4bcb1b1890
cp %{_builddir}/artikulate-21.04.2/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/artikulate/cc250ebd38b8d0ac13fc06208c14452ec41f40f1
cp %{_builddir}/artikulate-21.04.2/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/artikulate/cc250ebd38b8d0ac13fc06208c14452ec41f40f1
cp %{_builddir}/artikulate-21.04.2/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/artikulate/cbca59e0e62dd8bfc0468847678552cadebea0a9
cp %{_builddir}/artikulate-21.04.2/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/artikulate/cbca59e0e62dd8bfc0468847678552cadebea0a9
cp %{_builddir}/artikulate-21.04.2/LICENSES/MIT.txt %{buildroot}/usr/share/package-licenses/artikulate/a0193e3fccf86c17dc71e3f6c0ac0b535e06bea3
cp %{_builddir}/artikulate-21.04.2/libsound/src/qtgstreamerbackend/qtgstreamerbackend.json.license %{buildroot}/usr/share/package-licenses/artikulate/cb036b5481429dea37c9c20c313d7aa1d911b181
cp %{_builddir}/artikulate-21.04.2/libsound/src/qtmultimediabackend/qtmultimediabackend.json.license %{buildroot}/usr/share/package-licenses/artikulate/cb036b5481429dea37c9c20c313d7aa1d911b181
pushd clr-build
%make_install
popd
