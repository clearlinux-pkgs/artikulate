...
Version  : 23.08.1
Release  : 58
URL      : https://download.kde.org/stable/release-service/23.08.1/src/artikulate-23.08.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.08.1/src/artikulate-23.08.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.1/src/artikulate-23.08.1.tar.xz.sig
...
%prep
%setup -q -n artikulate-23.08.1
cd %{_builddir}/artikulate-23.08.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1695066929
mkdir -p clr-build
pushd clr-build
