...
Source0  : https://download.kde.org/stable/release-service/22.08.2/src/artikulate-22.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.08.2/src/artikulate-22.08.2.tar.xz.sig
...
%prep
%setup -q -n artikulate-22.08.2
cd %{_builddir}/artikulate-22.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665711144
mkdir -p clr-build
pushd clr-build
